  ...
  return (
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className='navbar-nav m-auto'>
            ...
            <li className='nav-item mx-3'><NavLink to='/products' className='nav-link text-dark'><i class="bi bi-cart-check fs-4"></i></NavLink></li>
            <li className='nav-item mx-3'><NavLink to='/products' className='nav-link text-dark'><i class="bi bi-person-circle fs-4"></i></NavLink></li>
            <li className='nav-item mx-3'><input type='search' placeholder='search for products...' /><button className='btn btn-primary ms-3'>Search</button></li>
        </ul>
      </div>
    </nav>
    </div>
